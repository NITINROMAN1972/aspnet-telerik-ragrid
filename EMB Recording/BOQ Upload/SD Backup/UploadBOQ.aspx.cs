...
public partial class Emp_Calculation_UploadBOQ : System.Web.UI.Page
{
    ...
    public void Bind_Role_ProjectMaster()
    {
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            ...
            ddProjectMaster.DataValueField = "ProjectCode";
    ...
    public void Bind_Role_AODetails(string selectedProjectMaster)
    {
        ...
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            ...
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@AOProject", projectMasterDt.Rows[0]["ProjectName"].ToString());
            cmd.ExecuteNonQuery();
    ...
    public void Bind_Role_WorkOrderDetails(string selectedProjectMaster, string selectedAODetails)
    {
        ...
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            ...
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@woProject", projectMasterDt.Rows[0]["ProjectName"].ToString());
            cmd.Parameters.AddWithValue("@woApprvAO", AoDetailsDt.Rows[0]["AONo"].ToString());
            cmd.ExecuteNonQuery();
            ...
            ddWorkOrder.DataValueField = "woTendrNo";
    ...
    private DataTable getProjectMaster(string selectedProjectMasterCode)
    {
        ...
        {
            con.Open();
            string sql = "SELECT * FROM ProjectMaster874 where ProjectCode=@ProjectCode";
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@ProjectCode", selectedProjectMasterCode.ToString());
            cmd.ExecuteNonQuery();
